...
- (void)initQCARInBackground
{
    ...
    @autoreleasepool {
        QCAR::setInitParameters(mQCARInitFlags,"");
        ...
        if (100 == initSuccess || -5 == initSuccess) {
...
- (void) showErrorDialogWithTitle: (NSString*) title errorMessage: (NSString*) message {
...
-(void) showCameraAccessWarning
{
    ...
    NSString* errorTitle = NSLocalizedString(@"GEN_CAMERA_ACCESS_WARNING_TITLE", @"Camera Access Warning Dialog Title");
...
- (void) errorMessage:(NSString *) message {
    UIAlertController* alert = [UIAlertController alertControllerWithTitle: SAMPLE_APPLICATION_ERROR_DOMAIN
                                                                   message: message
                                                            preferredStyle: UIAlertControllerStyleAlert];
